...
export default function ContactPage() {
  ...
  const inputClass = (hasError: boolean) =>
    `w-full bg-bg-card border rounded-btn px-4 py-3 text-text-primary placeholder-text-muted text-sm focus:outline-none focus:ring-1 transition-all duration-200 ${
      hasError
        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="bg-bg-card border border-bg-border rounded-[20px] p-6">
              ...
              {/* Replace href with real Calendly URL */}
              <a
            ...
            {/* Map: simplified Latin America SVG */}
